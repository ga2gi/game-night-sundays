  ...
  const suspects = [
    {
      ...
      threat: "High",
      motive: "Divorce finalized two years ago. Legal documents show Susan revised her will shortly before her death. Multiple witnesses describe continued tension between them.",
